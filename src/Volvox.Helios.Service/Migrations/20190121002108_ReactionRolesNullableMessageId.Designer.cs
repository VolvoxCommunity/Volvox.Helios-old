...
namespace Volvox.Helios.Service.Migrations
{
    ...
    [Migration("20190121002108_ReactionRolesNullableMessageId")]
    partial class ReactionRolesNullableMessageId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volvox.Helios.Domain.Module.ReactionRolesEmoteMapping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long>("ReactionRoleMessageId");

                    b.Property<long?>("ReactionRolesMessageId");
                    ...
                    b.HasIndex("ReactionRolesMessageId");

                    b.ToTable("ReactionRoleEmoteMappings");
                });

            modelBuilder.Entity("Volvox.Helios.Domain.Module.ReactionRolesMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("GuildId", "MessageId", "ChannelId");
            ...
            modelBuilder.Entity("Volvox.Helios.Domain.ModuleSettings.ReactionRoleSettings", b =>
                {
                    b.Property<decimal>("GuildId")
                        .ValueGeneratedOnAdd()
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
                    ...
                    b.ToTable("ReactionRoleSettings");
                });
            ...
            modelBuilder.Entity("Volvox.Helios.Domain.Module.ReactionRolesEmoteMapping", b =>
                {
                    b.HasOne("Volvox.Helios.Domain.Module.ReactionRolesMessage")
                        .WithMany("RollMappings")
                        .HasForeignKey("ReactionRolesMessageId");
                });
